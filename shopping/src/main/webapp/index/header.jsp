...
<div id="searchss">
    <div class="search">
        ...
        <div class="sear_fir">
            ...
            <div class="sinup">
                <a target="_blank" href="../admin.jsp">后台管理系统</a>
            </div>
            <c:if test="${sessionScope.user!=null}">
                <div class="sigin">
...
<div id="navall">
    <div id="nav">
        ...
        <ul id="inav">
            ...
            <li <c:if test="${flag==2}">class="active"</c:if>><a href="today">猜你喜欢</a></li>
            <li <c:if test="${flag==3}">class="active"</c:if>><a href="hot">热销商品</a></li>
